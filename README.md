...
- Диагностика
   ...
   - Отображение базовых параметров мотоцикла через смартфон, в т.ч. специфичных для 
   - Считывание и стирание ошибок ЭБУ
   - Считывание показаний моточасов из ЭБУ (всего часов, на холостых оборотах, под нагрузкой)
