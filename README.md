...
- Переключение карт ECU при помощи внешнего переключателя или смартфона
- Отображение текущей карты ECU на внешнем индикаторе
- Отображение наличия ошибок ECU на внешнем индикаторе
- Стирание ошибок ECU (внешней кнопкой или со смартфона)
- Считывание параметров и датчиков мотоцикла (диагностика) и их просмотр со смартфона/ноутбука
- Отображение параметров в виде графиков
- Обновляемая прошивка устройства, в том числе "по воздуху", без использования кабелей
